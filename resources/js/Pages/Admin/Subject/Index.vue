<template>
      ...
      <div class="container mx-auto py-8">
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
          <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-300">Subjects</h1>
            <Link href="/admin/subjects/create" class="btn-primary flex items-center">
              ...
              <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-700">
                <tr v-for="subject in subjects" :key="subject.id">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <Link :href="route('admin.subjects.edit', subject.id)" class="inline-flex items-center text-blue-600 hover:text-blue-800 bg-blue-100 hover:bg-blue-200 dark:bg-blue-600 dark:text-white dark:hover:bg-blue-500 dark:hover:text-gray-100 px-3 py-2 rounded transition duration-200 ml-4">
                    ...
                    <button @click="confirmDelete(subject.id)" class="inline-flex items-center text-red-600 hover:text-red-800 bg-red-100 hover:bg-red-200 dark:bg-red-600 dark:text-white dark:hover:bg-red-500 dark:hover:text-gray-100 px-3 py-2 rounded transition duration-200 ml-4">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
  ...
  function deleteSubject() {
    if (subjectToDelete.value) {
      form.delete(route('admin.subjects.destroy', subjectToDelete.value), {
        onSuccess: () => {
