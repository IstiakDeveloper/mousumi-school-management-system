      ...
      <div class="container mx-auto py-8">
        <div class="bg-white shadow-lg rounded-lg p-8">
          <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Parents</h1>
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="parent in parents" :key="parent.id">
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ parent.user.name }}</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ parent.user.email }}</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ parent.phone }}</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ parent.address }}</td>
