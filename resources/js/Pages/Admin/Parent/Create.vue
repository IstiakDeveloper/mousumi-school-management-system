    ...
    <AdminLayout>
        <div class=" mx-auto py-8">
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
                <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-300 mb-6">Create Parent</h1>
...
function submit() {
    form.post(route('admin.parents.store'), {
        onSuccess: () => {
            // Redirect to the parents index after successful creation
            // e.g., this.$inertia.visit(route('admin.parents.index'));
        },
        onError: () => {
