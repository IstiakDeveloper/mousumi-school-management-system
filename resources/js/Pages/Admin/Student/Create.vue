    ...
    <AdminLayout>
      <div class="container mx-auto py-8">
        <div class="bg-white shadow-lg rounded-lg p-8">
          <h1 class="text-3xl font-bold text-gray-800 mb-6">Create Student</h1>
          ...
          <form @submit.prevent="submit">
            ...
            <div class="mb-4">
              ...
              <div>
                <label for="birth_certificate_number" class="block text-sm font-medium text-gray-700">Birth Certificate Number</label>
                <input 
              ...
              <div>
                <label for="birth_place_district" class="block text-sm font-medium text-gray-700">Birth Place District</label>
                <input 
              ...
              <div>
                ...
                <select v-model="form.gender" id="gender" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
              ...
              <div>
                <label for="class_role" class="block text-sm font-medium text-gray-700">Class Role</label>
                <input 
              ...
              <div>
                <label for="minorities" class="block text-sm font-medium text-gray-700">Minorities</label>
                <input type="checkbox" v-model="form.minorities" id="minorities" />
              </div>

              <div>
                <label for="minority_name" class="block text-sm font-medium text-gray-700">Minority Name</label>
                <input 
              ...
              <!-- Mother Details -->
              <h2 class="text-xl font-semibold mt-6">Mother Details</h2>
              <div>
                <label for="mother_name_en" class="block text-sm font-medium text-gray-700">Mother's Name</label>
                <input 
              ...
              <div>
                <label for="mother_nid" class="block text-sm font-medium text-gray-700">Mother's NID</label>
                <input 
              ...
              <!-- Father Details -->
              <h2 class="text-xl font-semibold mt-6">Father Details</h2>
              <div>
              ...
              <div>
                <label for="father_nid" class="block text-sm font-medium text-gray-700">Father's NID</label>
                <input 
              ...
              <div>
                ...
                <select v-model="form.class_id" id="class_id" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
              ...
              <div>
                ...
                <select v-model="form.section_id" id="section_id" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
              ...
              <div>
                ...
                <select v-model="form.parent_id" id="parent_id" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
              ...
              <!-- Present Address -->
            <h2 class="text-xl font-semibold mt-6">Present Address</h2>
            <div>
                <label for="present_address_division" class="block text-sm font-medium text-gray-700">Division</label>
                <select 
              ...
              <div>
                <label for="present_address_district" class="block text-sm font-medium text-gray-700">District</label>
                <select 
              ...
              <div>
                <label for="present_address_upazila" class="block text-sm font-medium text-gray-700">Upazila</label>
                <select 
            ...
            <div>
            <label for="present_address_city" class="block text-sm font-medium text-gray-700">City</label>
            <input 
            ...
            <div>
            <label for="present_address_ward" class="block text-sm font-medium text-gray-700">Ward</label>
            <input 
            ...
            <div>
            <label for="present_address_village" class="block text-sm font-medium text-gray-700">Village</label>
            <input 
            ...
            <div>
            <label for="present_address_house_number" class="block text-sm font-medium text-gray-700">House Number</label>
            <input 
            ...
            <div>
            <label for="present_address_post" class="block text-sm font-medium text-gray-700">Post</label>
            <input 
            ...
            <div>
            <label for="present_address_post_code" class="block text-sm font-medium text-gray-700">Post Code</label>
            <input 
            ...
            <!-- Permanent Address -->
            <h2 class="text-xl font-semibold mt-6">Permanent Address</h2>
            <div>
            <label for="permanent_address_division" class="block text-sm font-medium text-gray-700">Division</label>
            <select 
            ...
            <div>
            <label for="permanent_address_district" class="block text-sm font-medium text-gray-700">District</label>
            <select 
            ...
            <div>
            <label for="permanent_address_upazila" class="block text-sm font-medium text-gray-700">Upazila</label>
            <select 
            ...
            <div>
            <label for="permanent_address_city" class="block text-sm font-medium text-gray-700">City</label>
            <input 
            ...
            <div>
            <label for="permanent_address_ward" class="block text-sm font-medium text-gray-700">Ward</label>
            <input 
            ...
            <div>
            <label for="permanent_address_village" class="block text-sm font-medium text-gray-700">Village</label>
            <input 
            ...
            <div>
            <label for="permanent_address_house_number" class="block text-sm font-medium text-gray-700">House Number</label>
            <input 
            ...
            <div>
            <label for="permanent_address_post" class="block text-sm font-medium text-gray-700">Post</label>
            <input 
            ...
            <div>
            <label for="permanent_address_post_code" class="block text-sm font-medium text-gray-700">Post Code</label>
            <input 
            ...
            <div>
                <label for="information_correct" class="inline-flex items-center">
                  ...
                  />
                  <span class="ml-2 text-sm text-gray-700">I confirm that the information provided is correct</span>
                </label>
              </div>              
            </div>
