      ...
      <div class="container mx-auto py-8">
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
          <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-300">Users</h1>
            ...
            <table class="min-w-full divide-y divide-gray-200">
              <thead class="bg-gray-100 dark:bg-gray-700">
                <tr>
                  ...
                  <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-300">Roles</th>
              ...
              <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-600">
                <tr v-for="user in users" :key="user.id">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    ...
                    <button @click="confirmDelete(user.id)" class="text-red-600 hover:text-red-900 ml-4 dark:text-red-400 dark:hover:text-red-300">Delete</button>
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <div v-if="showModal" class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
            ...
            <h2 class="text-2xl font-bold mb-4 dark:text-gray-300">{{ isEditing ? 'Edit' : 'Create' }} User</h2>
            <form @submit.prevent="submit">
                ...
                <input
                    ...
                    id="name"
                    v-model="form.name"
                    class="mt-1 block w-full bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-gray-900 dark:text-gray-300 placeholder-gray-500 dark:placeholder-gray-400"
                ...
                <select
                    id="role"
                    v-model="form.role"
                    class="mt-1 block w-full bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-gray-900 dark:text-gray-300"
                    required
                >
