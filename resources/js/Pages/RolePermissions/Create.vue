        ...
        <form @submit.prevent="assignPermissions">
            <div class="mb-4">
                ...
                <select
                    ...
                    class="form-select mt-1 block w-full border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-300"
              ...
              <div v-for="permission in permissions" :key="permission.id" class="mr-4 mb-2">
                <label class="inline-flex items-center">
                  <input
                    ...
                    class="form-checkbox"
                  />
                  <span class="ml-2 dark:text-gray-300">{{ permission.name }}</span>
                </label>
              </div>
            </div>
...
.dark .form-select {
  @apply bg-gray-700 text-gray-300 border-gray-600; /* Dark mode styles */
}

.dark  .form-checkbox {
  @apply bg-gray-700 h-4 w-4 text-indigo-600 transition duration-150 ease-in-out;
}
</style>
