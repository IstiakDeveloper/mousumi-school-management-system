...
const navItems = ref([
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Teacher Salaries', link: '/admin/teachers/salaries', icon: 'M5 5h14v14H5V5z', isActive: false },
  ...
  },
  {
    ...
    isActive: false,
    children: [
      { name: 'Expenses', link: '/admin/reports/expenses', icon: 'M5 5h14v14H5V5z', isActive: false },
      { name: 'Student Fees', link: '/admin/reports/student-fees', icon: 'M5 5h14v14H5V5z', isActive: false },
      { name: 'Teacher Salaries', link: '/admin/reports/teacher-salaries', icon: 'M2 2h20v20H2V2z', isActive: false },
      { name: 'Bank Balance', link: '/admin/reports/bank-balance', icon: 'M2 2h20v20H2V2z', isActive: false },
    ],
  ...
  },
  {
    ...
    isActive: false,
    children: [
      { name: 'Teacher Attendance', link: '/admin/teacher-attendance', icon: 'M5 5h14v14H5V5z', isActive: false },
    ],
